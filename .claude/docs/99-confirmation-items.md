...
**最終更新**: 2026-01-25
**ステータス**: 利用者向けUI全画面完了（277テスト）、職員向けUI全画面完了（210テスト）、パスワードリセットAPI実装完了（TDD）
...
| 項目 | 状態 |
|------|------|
| U-09 パスワードリセットUI（利用者） | ✅ 完了（31テスト） |
| S-09 パスワードリセットUI（職員） | ✅ 完了（28テスト） |
| 動画アクセス制御 | 未着手 |
| レート制限 | 未着手 |
| パスワードリセットメール送信 | スタブ実装（Mailer未実装） |
...
- [ ] パスワードリセットメール送信実装（現在はスタブ）
- [x] U-09 パスワードリセットUI（利用者向けフロントエンド） ← **2026-01-25完了**
- [x] S-09 パスワードリセットUI（職員向けフロントエンド） ← **既に完了済み**
- [ ] フロントエンド-バックエンド接続（API連携）
- [ ] 動画アクセス制御実装
- [ ] レート制限実装
