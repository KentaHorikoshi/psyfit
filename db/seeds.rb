...
exercise_data = [
  # ストレッチ
  { name: '肘を曲げる運動', exercise_type: 'ストレッチ', difficulty: 'easy', body_part_major: '上肢', body_part_minor: '肘・前腕', description: "肘が90度以上曲がり1秒キープしたら「達成」です", video_url: '/videos/elbow-flexion.mp4', thumbnail_url: '/thumbnails/elbow-flexion.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },
  { name: '上肢回旋（ソラシックツイスト）', exercise_type: 'ストレッチ', difficulty: 'medium', body_part_major: '体幹・脊柱', body_part_minor: '胸部・腹部', description: "上側の指先を見ながら、首も一緒に動かします\n手だけを動かさないように注意します\n下半身は動かさないようにします\n手を真上に上げた際に脱力します", video_url: '/videos/thoracic-twist.mp4', thumbnail_url: '/thumbnails/thoracic-twist.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },
  { name: '下肢回旋（両膝倒しツイスト）', exercise_type: 'ストレッチ', difficulty: 'medium', body_part_major: '体幹・脊柱', body_part_minor: '腰椎・骨盤', description: "手は広げて実施します\n肩が浮かないように実施します\n両膝はつけたまま実施します", video_url: '/videos/knee-drop-twist.mp4', thumbnail_url: '/thumbnails/knee-drop-twist.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },
  { name: 'キャットアンドドッグ', exercise_type: 'ストレッチ', difficulty: 'hard', body_part_major: '体幹・脊柱', body_part_minor: '腹部・胸部', description: "両手、両膝は肩幅に開いてつきます\n背骨を動かす時は骨盤の方から動かします", video_url: '/videos/cat-and-dog.mp4', thumbnail_url: '/thumbnails/cat-and-dog.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },
  { name: '背中丸め（座位片膝抱えストレッチ）', exercise_type: 'トレーニング', difficulty: 'easy', body_part_major: '体幹・脊柱', body_part_minor: '腹部・胸部', description: "肩の力を抜いて実施します\n肘を伸ばして実施します", video_url: '/videos/seated-knee-hug-stretch.mp4', thumbnail_url: '/thumbnails/seated-knee-hug-stretch.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },

  # トレーニング
  { name: 'チェアスクワット', exercise_type: 'トレーニング', difficulty: 'easy', body_part_major: '下肢', body_part_minor: '股関節・大腿', description: "膝がつま先より前に出ないようにします\n膝の向きはつま先と同じにします\n足を肩幅に広げます\n椅子に浅く座ります\n立つのに3秒、座るのに5秒かけます\n座る際はゆっくり座ります", video_url: '/videos/chair-squat.mp4', thumbnail_url: '/thumbnails/chair-squat.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },
  { name: '膝伸ばし（座位膝伸展運動）', exercise_type: 'トレーニング', difficulty: 'easy', body_part_major: '下肢', body_part_minor: '膝・下腿', description: "反対側の膝の高さまで上げます\n深く座った状態で、ひざ下のみを伸ばします\nつま先を自分側に向けて実施します", video_url: '/videos/seated-knee-extension.mp4', thumbnail_url: '/thumbnails/seated-knee-extension.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },
  { name: 'ロールダウン', exercise_type: 'トレーニング', difficulty: 'medium', body_part_major: '体幹・脊柱', body_part_minor: '腹部・胸部', description: "両足底は床につけておきます\n両膝の間にクッションを挟むとお腹に力が入りやすいです\n体は丸まったまま実施し、腰をそらさないようにします\n倒れるぎりぎりのところまで倒して体を起こします", video_url: '/videos/roll-down.mp4', thumbnail_url: '/thumbnails/roll-down.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },
  { name: '殿筋トレーニング(膝屈曲位うつ伏せ股関節伸展運動)', exercise_type: 'トレーニング', difficulty: 'medium', body_part_major: '下肢', body_part_minor: '股関節・大腿', description: "実施側の膝は90度以上曲げて行います\n骨盤が浮かないようにつけたまま実施します", video_url: '/videos/prone-hip-extension.mp4', thumbnail_url: '/thumbnails/prone-hip-extension.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },
  { name: '膝つきプランク', exercise_type: 'トレーニング', difficulty: 'hard', body_part_major: '体幹・脊柱', body_part_minor: '腹部・胸部', description: "15秒間実施にて1回とします\n腰が反ったり丸まったりしないよう注意します\n肩、膝、体を一直線にします\n両膝、両肘の間隔は肩幅に保ちます", video_url: '/videos/kneeling-plank.mp4', thumbnail_url: '/thumbnails/kneeling-plank.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 },
  { name: 'バックブリッジ', exercise_type: 'トレーニング', difficulty: 'hard', body_part_major: '体幹・脊柱', body_part_minor: '腰椎・骨盤', description: "膝は90度曲げ、足は肩幅に広げます\nお尻を挙げる際は膝と体と肩を一直線にします\n腰が反らないように注意します\nクッションを挟むとより効果的です", video_url: '/videos/back-bridge.mp4', thumbnail_url: '/thumbnails/back-bridge.jpg', duration_seconds: 180, recommended_reps: 10, recommended_sets: 3 }
]
